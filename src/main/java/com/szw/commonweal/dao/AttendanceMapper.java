...
public interface AttendanceMapper extends BaseMapper<Attendance> {
    ...
    @Update("update attendance set voucher =#{voucher}, content =#{content} where user_id=#{userId} and serial_num=#{serialNum}; ")
    int signIN(String voucher,int serialNum,String userId ,String content);
